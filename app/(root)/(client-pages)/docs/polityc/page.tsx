      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="">
          <p className="mt-10">
            ...
            которую сайт <strong>&quot;Партнер&quot;</strong>, (далее – Сайт)
            расположенный на доменном имени <strong>partner13.ru</strong> (а
            также его субдоменах), может получить о Пользователе во время
            использования сайта partner13.ru (а также его субдоменов), его
          ...
          <strong className="font-normal">
            <p>
              ...
              <strong>&quot;Партнер&quot;</strong>, действующие от имени ООО
              Партнер ОГРН1181326005640, которые организуют и (или) осуществляют
            ...
            <p>
              2.1. Использование сайта &quot;Партнер&quot; Пользователем
            ...
            <p>
              ...
              &quot;Партнер&quot;. Сайт не контролирует и не несет
              ответственность за сайты третьих лиц, на которые Пользователь
              может перейти по ссылкам, доступным на сайте &quot;Партнер&quot;.
            </p>
            ...
            <p>
              ...
              регистрации на сайте &quot;Партнер&quot;, при подписке на
            ...
            <p>
              ...
              Пользователем путём заполнения форм на сайте &quot;Партнер&quot; и
            ...
            <p>
              ...
              &quot;Партнер&quot;, если Пользователь дал согласие на создание
              учетной записи.
              <br />
              ...
              сведений от имени сайта &quot;Партнер&quot;.
              <br />
            ...
            <p>
              ...
              &quot;Партнер&quot;, включая доставку Товара, документации или
              e-mail сообщений.
            </p>
            <p>
            ...
            <p>
              ...
              &quot;Партнер&quot;, и давать согласие на их обработку.
            </p>
            ...
            <p>
              ...
              &quot;Партнер&quot;, несет лицо, предоставившее такую информацию.
            </p>

            <p>
              7.5. Пользователь соглашается, что информация, предоставленная ему
              как часть сайта &quot;Партнер&quot;, может являться объектом
              интеллектуальной собственности, права на который защищены и
              принадлежат другим Пользователям, партнерам или рекламодателям,
            ...
            <p>
              ...
              &quot;Партнер&quot;) допускается их распространение при условии,
            ...
            <p>
              ...
              &quot;Партнер&quot; или передаваемых через него.
            </p>
            ...
            <p>
              ...
              информацию, размещенную пользователем на сайте
              &quot;Партнер&quot;, включая, но не ограничиваясь: информацию,
            ...
            <p>
              ...
              рассмотрение Арбитражного суда г. Рузаевка.
            </p>
            ...
            <p>
              ...
              ее размещения на сайте &quot;Партнер&quot;, если иное не
              предусмотрено новой редакцией Политики конфиденциальности.
            </p>

            <p>
              9.3. Все предложения или вопросы касательно настоящей Политики
              конфиденциальности следует сообщать по адресу: info@partner13.ru
            </p>

            <p>
              9.4. Действующая Политика конфиденциальности размещена на странице
              по адресу http://partner13.ru/doc/privacy-policy
            </p>

            <p>Обновлено: 22 Мая 2024 года</p>
            <p>г. Рузаевка, ООО Партнер ОГРН1181326005640</p>
          </strong>
        </div>
      </div>
    </div>
