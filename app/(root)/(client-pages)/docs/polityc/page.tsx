export const metadata = {
  title: "Защита персональных данных - ТЭРРА",
  description:
...
export default function PolitycPage() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className=" overflow-hidden flex justify-between items-start">
          <h2 className="text-3xl max-w-2xl lg:text-4xl">
            ...
            <span className="text-accent">персональных данных</span> ООО ТЭРРА
          </h2>
        </div>
        <div className="">
          <p className="mt-10">
            ...
            которую сайт <strong>&quot;ТЭРРА&quot;</strong>, (далее – Сайт)
            расположенный на доменном имени <strong>terra-holod.ru</strong> (а
            также его субдоменах), может получить о Пользователе во время
            использования сайта terra-holod.ru (а также его субдоменов), его
          ...
          <strong className="font-normal">
            <p>
              ...
              <strong>&quot;ТЭРРА&quot;</strong>, действующие от имени ООО ТЭРРА
              ОГРН1221300003704, которые организуют и (или) осуществляют
            ...
            <p>
              ...
              сети, через который Пользователь получает доступ на Сайт.
            </p>

            <p>
              1.1.9. «Товар » - продукт, который Пользователь заказывает на
              сайте и оплачивает через платёжные системы.
            </p>

            <h2 className="mt-4 mb-2 font-bold text-lg">2. Общие положения</h2>
            <p>
              2.1. Использование сайта &quot;ТЭРРА&quot; Пользователем означает
            ...
            <p>
              ...
              &quot;ТЭРРА&quot;. Сайт не контролирует и не несет ответственность
              за сайты третьих лиц, на которые Пользователь может перейти по
              ссылкам, доступным на сайте &quot;ТЭРРА&quot;.
            </p>
            ...
            <p>
              ...
              регистрации на сайте &quot;ТЭРРА&quot;, при подписке на
            ...
            <p>
              ...
              Пользователем путём заполнения форм на сайте &quot;ТЭРРА&quot; и
              ...
              <br />
              3.2.5. адрес доставки Товара (при необходимости) 3.2.6. фотографию
              (при необходимости).
            </p>
            ...
            <p>
              ...
              частям сайта, требующим отображения конткнта.
            </p>
            ...
            <p>
              ...
              &quot;ТЭРРА&quot; для его дальнейшей авторизации, оформления
              заказа и других действий.
              <br />
              ...
              &quot;ТЭРРА&quot;, оказания услуг и обработки запросов и заявок от
              Пользователя.
              <br />
              ...
              &quot;ТЭРРА&quot;, если Пользователь дал согласие на создание
              учетной записи.
              <br />
            ...
            <p>
              ...
              &quot;ТЭРРА&quot;, включая доставку Товара, документации или
              e-mail сообщений.
            </p>
            <p>
            ...
            <p>
              ...
              &quot;ТЭРРА&quot;, и давать согласие на их обработку.
            </p>
            ...
            <p>
              ...
              Администрация не несёт ответственность, если данная
            ...
            <p>
              ...
              &quot;ТЭРРА&quot;, несет лицо, предоставившее такую информацию.
            </p>

            <p>
              7.5. Пользователь соглашается, что информация, предоставленная ему
              как часть сайта &quot;ТЭРРА&quot;, может являться объектом
              интеллектуальной собственности, права на который защищены и
              принадлежат другим Пользователям, ТЭРРАам или рекламодателям,
              которые размещают такую информацию на сайте &quot;Дом
              Эксперт&quot;. <br />
            ...
            <p>
              ...
              &quot;ТЭРРА&quot;) допускается их распространение при условии, что
              будет дана ссылка на Сайт.
            </p>
            ...
            <p>
              ...
              &quot;ТЭРРА&quot; или передаваемых через него.
            </p>
            ...
            <p>
              ...
              информацию, размещенную пользователем на сайте &quot;ТЭРРА&quot;,
            ...
            <p>
              ...
              рассмотрение Арбитражного суда г. Саранск.
            </p>
            ...
            <p>
              ...
              ее размещения на сайте &quot;ТЭРРА&quot;, если иное не
              предусмотрено новой редакцией Политики конфиденциальности.
            </p>

            <p>
              9.3. Все предложения или вопросы касательно настоящей Политики
              конфиденциальности следует сообщать по адресу: info@terra-holod.ru
            </p>

            <p>
              9.4. Действующая Политика конфиденциальности размещена на странице
              по адресу http://terra-holod.ru/doc/privacy-policy
            </p>

            <p>Обновлено: 26 Октября 2024 года</p>
            <p>г. Саранск, ООО ТЭРРА ОГРН1221300003704</p>
          </strong>
        </div>
      </div>
    </div>
