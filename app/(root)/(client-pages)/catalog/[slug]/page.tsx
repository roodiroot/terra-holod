                ...
                <ul className="space-y-3 mt-4 text-lg">
                  ...
                  <li className="relative pl-1.5  my-2  pr-6 w-full flex gap-4 justify-between sm:pl-6 sm:before:top-1/2 sm:before:-translate-y-1/2 sm:before:absolute sm:before:left-2 sm:before:w-1 sm:before:h-1 sm:before:bg-slate-200">
                    ...
                    <div className="flex flex-col gap-1 items-end">
                      {product.productsFields.volumeOfRefrigerator && <span className="text-gray-900 font-bold text-right leading-4">
                        {product.productsFields.volumeOfRefrigerator}
                      </span>}
                      {product.productsFields.volume1 && <span className="text-gray-900 font-bold text-right leading-4">
                        {product.productsFields.volume1}
                      </span>}
                      {product.productsFields.volume2 && <span className="text-gray-900 font-bold text-right leading-4">
                        {product.productsFields.volume2}
                      </span>}
                      {product.productsFields.volume3 && <span className="text-gray-900 font-bold text-right leading-4">
                        {product.productsFields.volume3}
                      </span>}
                    </div>
