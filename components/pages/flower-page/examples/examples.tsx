  ...
  return (
    <SectionContainer className="">
      <div className="pb-[100px] md:pb-[160px] pt-[60px]">
        ...
        <div className="flex flex-col mt-8 gap-[30px] max-w-md mx-auto lg:max-w-none lg:flex-row lg:items-center">
          ...
          <div className="flex-1 space-y-10">
            ...
            <div className="">
              ...
              <p className="mt-4 text-xl">
                Мы проектируем и строим индивидуальные цветочные камеры по
                запросу вашего бизнеса. Они позволяют сохранять свежесть и
                привлекательность цветов благодаря оптимальным условиям
                хранения.
              </p>
            </div>
          </div>
