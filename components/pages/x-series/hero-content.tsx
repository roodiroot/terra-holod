  ...
  if (desctop)
    return <div className="relative w-full h-[596px] bg-sky-300 rounded-[60px] overflow-y-hidden">
      <div className="absolute inset-0 z-10 p-14">
        <h1 className="font-bold text-5xl md:text-6xl text-white max-w-md leading-[90%] lg:text-balance">Сплит-системы <span className="whitespace-nowrap">X-Series</span></h1>
  ...
  return (
    <div className="relative aspect-[1.5/2] w-full bg-sky-300 rounded-[60px] overflow-y-hidden">
      <div className="absolute inset-0 z-10 p-8">
        <h1 className="font-bold text-5xl text-white leading-[90%] lg:text-balance">Сплит-системы <span className="whitespace-nowrap">X-Series</span></h1>
